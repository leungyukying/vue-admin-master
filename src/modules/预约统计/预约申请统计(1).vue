    ...
    <div class="main-con">
      <div class="search-con shadow">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline">
          ...
          <div class="btn-con">
            <el-button type="primary" @click="quding()">确认</el-button>
  ...
  methods: {
    ...
    async quding() {
      var msgBody = {
        root: {
          CountInfor: {
            BeginDate: this.formInline.value[0]
            ...
            EndDate: this.formInline.value[1]
              ...
              : "",
            StudyHospital: this.formInline.region1,
            studyType: this.formInline.region2,
            StudyItem: this.formInline.region3
          }
        }
      };
      var xdsrw = [];
      var patientParams = {
        msgHeader:
          '{"root":{"HeaderInfor":{"serviceName":"AppInCount","event":"countPatientIn"}}}',
      ...
      var patientParams = {
        msgHeader:
          '{"root":{"HeaderInfor":{"serviceName":"AppInCount","event":"countCheckedIn"}}}',
        msgBody: JSON.stringify(msgBody)
      };
      var xsd = await this.$http.post(
        "/AppCountInterface/AppCount.asmx/callInterface",
      ...
      var patientParams = {
        msgHeader:
          '{"root":{"HeaderInfor":{"serviceName":"AppInCount","event":"countOrderIn"}}}',
        msgBody: JSON.stringify(msgBody)
      };
      var xsd = await this.$http.post(
        "/AppCountInterface/AppCount.asmx/callInterface",
      ...
      var patientParams = {
        msgHeader:
          '{"root":{"HeaderInfor":{"serviceName":"AppInCount","event":"countCheckedOrderIn"}}}',
        msgBody: JSON.stringify(msgBody)
      };
      var xsd = await this.$http.post(
        "/AppCountInterface/AppCount.asmx/callInterface",
      ...
      var patientParams = {
        msgHeader:
          '{"root":{"HeaderInfor":{"serviceName":"AppInCount","event":"countFeeIn"}}}',
        msgBody: JSON.stringify(msgBody)
      };
      var xsd = await this.$http.post(
        "/AppCountInterface/AppCount.asmx/callInterface",
